...
export class FilterService {
  ...
  setYearsFilter(startYear:number, endYear:number): Observable<any>{
    return this.http.post('/api/api/v1/filter/year', {
  ...
  deleteYearsFilter(): Observable<any>{
    return this.http.delete('/api/api/v1/filter/year');
  }

  getAttributes(): Observable<AttributeResponse[]>{
    return this.http.get<AttributeResponse[]>('/api/api/v1/filter/attribute');
  }

  setAttributeFilter(attributeName: string, attributeValue:string): Observable<any> {
    return this.http.post('/api/api/v1/filter/attribute', {
      name: attributeName,
  ...
  deleteAttributeFilter(attributeName: string): Observable<any>{
    return this.http.delete(`/api/api/v1/filter/attribute/${attributeName}`)
  }
